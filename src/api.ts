...
export const api = {
  ...
  calendar: (workspace: string) => request<{
    scheduledPosts: { id: number; day: number; hour: number; time: string; platform: Platform; connectionId: number | null; connectionAccount: string | null; caption: string; status: string; mediaUrl: string | null; mediaType: 'image' | 'video' | null; scheduledDate: string | null; publishStatus: string; publishError: string | null }[];
